"""
Django settings for any_lab_healthhub_45608 project.
...
ROOT_URLCONF = 'any_lab_healthhub_45608.urls'
...
WSGI_APPLICATION = 'any_lab_healthhub_45608.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "any_lab_healthhub_45608 API",
    "DESCRIPTION": "API documentation for any_lab_healthhub_45608 App",
    "VERSION": "v1",
}
